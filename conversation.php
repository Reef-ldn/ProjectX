...
$userSql = "SELECT username, profile_pic FROM users WHERE id = '$other_id'";
        ...
        <div class="chat-messages">
            ...
            if ($result && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<div class='msg-content'>" . htmlspecialchars($row['content']) . "<br><small>" . date('H:i', strtotime($row['created_at'])) . "</small></div>";
                    echo "</div>";
                }
            } else {
