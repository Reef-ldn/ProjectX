...
<body class="bg-light">
                ...
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <?php if ($postOwnerID == $loggedUserID): ?>
                      ...
                      <?php else: ?>
                        <!--If it's not highlighted already-->
                        <li><a class="dropdown-item" href="highlight_post.php?post_id=<?php echo $postID; ?>&action=add">Add to
                            Highlights</a></li>
                      <?php endif; ?>
                    <?php endif; ?>
  ...
  <div class="card p-3">
    ...
    </div>Display a 'Follow User' Button, if the profile being viewed is not the same as the logged in user
    <?php if ($loggedUserId != $profileUserId) {
